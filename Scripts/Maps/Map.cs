...
public class Map(int size = 10)
{
	...
	public int Seed = 0;
	public Dictionary<Vector2I,MapTile> Tiles = [];
	...
	public List<MapTile> GetNeighbors(Vector2I pos) => GetNeighbors(pos.X, pos.Y);

	public MapTile GetTile(int x, int y) => Tiles.GetValueOrDefault(new Vector2I(x, y), MapTile.VoidTile);
	public MapTile GetTile(Vector2I pos) => Tiles.GetValueOrDefault(pos, MapTile.VoidTile);

	public Vector2I GetTileCoord(MapTile neighbor)
	{
